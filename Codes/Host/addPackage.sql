...
BEGIN
	...
	DBMS_OUTPUT.PUT_LINE('Book Genre Not Authentic !');
	INSERT INTO BOOK3@site2(bookId,bookQuantity,bookAvailable) VALUES(x,quantity1,available1);

	INSERT INTO BOOK2@site2 (bookId,bookTitle,bookAuthor,bookGenre,bookPrice) VALUES (x,title1,author1,genre1,price1);
